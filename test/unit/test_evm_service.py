...
class TestEVMService:
    ...
    def test_sign_transaction(self, evm_service, mock_web3):
        ...
        mock_web3.eth.account.sign_transaction.assert_called_once_with(tx_params, private_key=private_key)
    ...
    def test_send_transaction(self, evm_service, mock_web3):
        ...
        expected_hash = HexBytes("0x1234567890123456789012345678901234567890123456789012345678901234")
        ...
        mock_web3.eth.account.sign_transaction.assert_called_once_with(tx_params, private_key=private_key)
        mock_web3.eth.send_raw_transaction.assert_called_once_with(mock_signed_tx.raw_transaction)
...
class TestEVMServiceIntegration:
    ...
    def test_error_handling_scenarios(self, evm_service, mock_web3):
        ...
        mock_web3.eth.account.sign_transaction.side_effect = Exception("Invalid private key")
    ...
    def test_edge_cases(self, evm_service, mock_web3):
        ...
        balance = evm_service.get_wallet_balance("0x1234567890123456789012345678901234567890")
